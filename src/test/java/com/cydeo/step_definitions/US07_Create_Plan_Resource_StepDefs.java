...
public class US07_Create_Plan_Resource_StepDefs extends APITestBase{
    ...
    @Then("the values of the {string}, {string}, {string}, and {string} fields should not be null")
    public void the_values_of_the_and_fields_should_not_be_null(String paymentId, String paymentKey, String priceId, String type) {
    ...
    @Then("the value of the {string} should be the same as the {string} in the request")
    public void the_value_of_the_should_be_the_same_as_the_in_the_request(String priceIdInResponse, String priceIdInRequest) {
        priceIdInResponse = jp.getString(priceIdInResponse);
        System.out.println("priceIdInRequest = " + priceIdInRequest);
        System.out.println("priceIdInResponse = " + priceIdInResponse);
